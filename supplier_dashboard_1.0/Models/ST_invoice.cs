...
namespace supplier_dashboard_1._0.Models
{
    ...
    public partial class ST_invoice
    {
        ...
        public Nullable<decimal> total_special_excise_duty { get; set; }
        public Nullable<decimal> total_sales_tax { get; set; }
        public Nullable<decimal> total_value_of_goods { get; set; }
